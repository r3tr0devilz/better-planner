    ...
    <div className="mx-auto w-full min-w-0 max-w-5xl">
      ...
      <section className="mt-8">
        ...
        <div className="mt-3 grid grid-cols-1 gap-2 sm:grid-cols-3">
          ...
          {topThree.length === 0 && (
            <p className="col-span-full border border-line bg-panel/86 p-4 text-sm text-ink-faint">
      ...
      <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-[1.4fr_1fr]">
        ...
        <div className="flex flex-col gap-8">
          <section className="border border-line bg-panel/86 p-4">
          ...
          <section>
            ...
            {burnEvents.length === 0 ? (
              <div className="mt-3 border border-line bg-panel/86 p-4">
                <p className="text-sm text-ink-faint">Nothing burned yet today.</p>
                <OpenCaptureButton />
              </div>
            ) : (
              <div className="mt-3 border border-line bg-panel/86">
                {burnEvents.slice(0, 5).map((e) => (
                  <div
                    key={e.id}
                    className="flex items-baseline justify-between gap-3 border-b border-line px-4 py-2.5 text-xs last:border-b-0"
                  >
